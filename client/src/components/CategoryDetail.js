  ...
  const handleClick = (e) => {
    ...
    switch (category[0].name) {
      ...
      case 'Plate':
        ...
        obj.plate.price = e.target.dataset.price;
      ...
      case 'PCB':
        ...
        obj.pcb.price = e.target.dataset.price;
      ...
      case 'Stabilizers': 
        ...
        obj.stabilizers.price = e.target.dataset.price;
      ...
      case 'Keycaps':
        ...
        obj.keycaps.price = e.target.dataset.price;
